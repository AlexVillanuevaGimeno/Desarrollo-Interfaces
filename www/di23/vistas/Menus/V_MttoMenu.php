...
<form  id="formBusquedaMenus" name="formBusquedaMenus">
    <button class="btn btn-primary" type="button" name="btnBuscarMenus" id="btnBuscarMenus" onclick="buscarMenus()">Buscar</button>
</form>
<form id="formularioCrearMenu" name="formularioCrearMenu">
    <div id="camposCrearMenu" style="display: none;">
        ...
        <button type="button" id="btnInsertar" class="btn btn-primary" onclick="validarMenu();">Insertar Menú</button>
    </div>
</form>
